...
class GameApp(object):
    ...
    def put_message_table(self, msg, is_front=False):
        if is_front:
            self.msg_teller.put_front(msg)
        else:
            self.msg_teller.put_back(msg)
